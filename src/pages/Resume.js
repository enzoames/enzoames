  ...
  return (
    <ResumePage>
      <Section>
        ...
        <ul>
          <li>
            Developing and innovating consumer and client facing interfaces across Foursquare's
            products.
          </li>
        ...
        <ul>
          <li>
            Managed and working in a team of four to develop Club Sporta’s MVP. Taking the project
            from a landing page to a full-fledge web app in an agile manner.
          </li>
          <li>
            Used Sketch to design the application’s interface and software development tools such a
            Trello - to assign tasks and manage sprints effectively.
          </li>
        ...
        {readMore && (
          <>
            ...
            <ul>
              <li>
                Selected to competitive full stack JavaScript training program that prepares
                students for careers in software engineering.
              </li>
            </ul>
            <ul>
              <li>
                Learn in-demand technologies like React, Node + Express and processes for design,
            ...
            <ul>
              <li>
                Worked in a team of three to create and design a web app that provides investment
                opportunities to Chinese or foreign investors.
              </li>
            </ul>
            <ul>
              <li>
                Contributed to the web scraping team by developing spiders that navigate through
                different websites to extract articles and market data.
              </li>
              <li>
                Front end stack consisted of React & Redux and back end Django Rest, Mongo, and
                Redis.
              </li>
            </ul>
            <p>
            ...
            <ul>
              <li>
                Introduced caseload of 12-15 freshmen and sophomore students to the fundamental
                concepts of computer science and evaluated student progress over the semester.
              </li>
            </ul>
            <p>
              <i>
            ...
            <ul>
              <li>
                Photographed student athletes as they compete in CUNY conference matches. Final
                edited images were presented to the Assistant Athletics Coordinator Director at CCNY
                for website use.
              </li>
            </ul>
            <p>
            ...
            <ul>
              <li>
                My love for photography and art, led me to become a freelance photographer. I shoot
                portraits, still, sports, and landscape photography till this day and I'm available
                upon request. It's a profession I keep very close.
              </li>
            </ul>
            <p>
              <i>
            ...
            <ul>
              <li>
                Presented, explained menu, and informed patrons of daily specials. Also answered any
            ...
            <ul>
              <li>
                Seasonal job that involves a lot of physical activity and attention to detail.
              </li>
            </ul>
            <p>
              <i>
            ...
            <ul>
              <li>
                Coached young athletes from the ages of 7 to 9 the basics of soccer through a series
                of 15 minute drills.
              </li>
              <li>
                Organized one-day soccer tournaments in school gymnasiums for different soccer clubs
                in the city.
              </li>
            </ul>
            <p>
            ...
            <ul>
              <li>
                Became responsible for ensuring the health, safety, and comfort of the dogs in care.
              </li>
            </ul>
            <p>
              <i>
            ...
            <ul>
              <li>
                Selected for a highly competitive mentorship program designed to teach peers about
                health education around NYC public schools.
              </li>
            </ul>
          </>
        )}
      ...
      <Section>
        ...
        <p>
          <strong>Technical Skills:</strong> Javascript, Scala, React, Redux, Styled Components,
          Node.js, HTML, CSS, AWS, Python, Gatsby, Webpack, Django REST Framework.
        </p>
        <p>
